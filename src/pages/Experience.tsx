              ...
              >
                {isLoading ? (
                  ...
                  <div className="card-content flex flex-col experience-card gap-3 h-full w-full  max-md:w-full">
                    <p
                      className={` font-semibold  text-[var(--headline)] cursor-pointer max-md:w-full ${animate}`}
                    ...
                    <div>
                      <p
                        className={`text-paragraph max-md:w-full max-md:max-w-[100%]  text-[var(--paragraph)] ${animate}`}
                      >
                        {experience.position}
                      </p>
                      <p
                        className={`text-paragraph max-md:w-full text-[var(--paragraph)] ${animate}`}
                      >
