...
export default function MailsAdminPage() {
  ...
  const formatDate = (daing: string | number | Date) => {
    const date = new Date(daing);
    ...
    <TooltipProvider delayDuration={0}>
      <div className="relative flex h-screen w-full overflow-hidden">
        <ResizablePanelGroup direction="horizontal">
          <ResizablePanel>
            <div className="flex w-full flex-col">
              ...
              <motion.div
                ...
                className="w-full flex-1 overflow-auto py-4"
              >
          ...
          <ResizablePanel
            className="border-l border-[var(--border)] bg-[var(--background)] max-md:hidden"
            defaultSize={30}
          >
            <div className="hidden h-full w-full overflow-auto p-6 md:block">
              {selectedMail && (
                <motion.div
                  initial={{
                    opacity: 0,
